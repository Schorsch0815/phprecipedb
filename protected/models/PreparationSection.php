...
class PreparationSection extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(array('seq_no, description, recipe_id', 'required'),
                array('seq_no, recipe_id', 'numerical', 'integerOnly' => true),
                array('name', 'length', 'max' => 64),
                array('description', 'length', 'max' => 256),
                // The following rule is used by search().
                // Please remove those attributes that should not be searched.
                array('id, name, seq_no, description, recipe_id', 'safe',
                        'on' => 'search'),);
    }
    ...
    public function relations()
    {
        ...
        return array('recipe' => array(self::BELONGS_TO, 'Recipe', 'recipe_id'),);
    }
