...
class IngredientController extends Controller
{
    ...
    {
        $dataProvider = new ApActiveDataProvider('Ingredient',
            array('alphapagination' => array('attribute' => 'name',)));
     ...
     * variable. If the data model is not found, an HTTP exception will
     * be raised.
