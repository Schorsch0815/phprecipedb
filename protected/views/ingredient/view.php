<?php
$this->breadcrumbs = array('Ingredients' => array('index'), $model->name,);

$this->menu = array(array('label' => 'List Ingredient', 'url' => array('index')),
        array('label' => 'Create Ingredient', 'url' => array('create')),
        array('label' => 'Update Ingredient',
                'url' => array('update', 'id' => $model->id)),
        array('label' => 'Delete Ingredient', 'url' => '#',
                'linkOptions' => array(
...
<?php $this
    ->widget(
        ...
        array('data' => $model,
                'attributes' => array('id', 'name', 'unit_usage',),));
?>
