...
class ApPagination extends CComponent
{
        ...
        if ($this->_currentPage === null) {
            if (isset($_GET[$this->pageVar])) {
                ...
                if ($this->_currentPage < -1
                    || $this->_currentPage > count($this->getCharSet()))
                    $this->_currentPage = -1;
            } else
                $this->_currentPage = -1;
        }
    ...
    {
        return ($this->_activeCharSet === null) ? $this->_charSet
            : $this->_activeCharSet;
    }
    ...
    {
        return ($this->_dbCharSet === null) ? $this->_charSet
            : $this->_dbCharSet;
    }
